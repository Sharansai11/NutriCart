...
const AddProduct = ({ onProductAdded, onCancel }) => {
  ...
  return (
    <div className="card shadow-lg rounded-3 border-0" style={{ maxWidth: "900px", margin: "0 auto" }}>
      <div className="card-header bg-gradient bg-success text-white p-4 rounded-top">
          ...
          <div className="card shadow-sm border-0 mt-4">
            <div className="card-body p-4">
              ...
              <div className="row">
                ...
                <div className="col-md-3 mb-3">
                  <label htmlFor="saturated-fat_100g" className="form-label fw-semibold">Saturated Fat (g)*</label>
                  <input
                    type="number"
                    step="0.01"
                ...
                <div className="col-md-3 mb-3">
                  <label htmlFor="carbohydrates_100g" className="form-label fw-semibold">Carbohydrates (g)*</label>
                  <input
                    type="number"
                    step="0.01"
              ...
              <div className="row">
                <div className="col-md-6">
                  ...
                  <div className="row align-items-end">
                    <div className="col-md-6 mb-3">
                      <label htmlFor="nutrition_grade_fr" className="form-label fw-semibold">Nutrition Grade (A-E)</label>
                      <input
                        type="text"
                ...
                <div className="col-md-6">
                  <h5 className="card-title border-bottom pb-2 mb-3 text-success">
                    <i className="bi bi-tags me-2"></i>Special Labels
                  </h5>
                  <div className="row">
                    <div className="col-md-6 mb-2">
                      <div className="form-check form-switch">
                        <input
                          ...
                          onChange={handleChange}
                        />
                        <label className="form-check-label fw-semibold" htmlFor="isFeature">
                          Featured Product
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6 mb-2">
                      <div className="form-check form-switch">
                        <input
                          ...
                          onChange={handleChange}
                        />
                        <label className="form-check-label fw-semibold" htmlFor="isNewArrival">
                          New Arrival
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6 mb-2">
                      <div className="form-check form-switch">
                        <input
                          ...
                          onChange={handleChange}
                        />
                        <label className="form-check-label fw-semibold" htmlFor="organicCertified">
                          Organic Certified
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6 mb-2">
                      <div className="form-check form-switch">
                        <input
                          ...
                          onChange={handleChange}
                        />
                        <label className="form-check-label fw-semibold" htmlFor="veganFriendly">
                          Vegan Friendly
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6 mb-2">
                      <div className="form-check form-switch">
                        <input
                          ...
                          onChange={handleChange}
                        />
                        <label className="form-check-label fw-semibold" htmlFor="glutenFree">
                          Gluten-Free
                        </label>
                      </div>
                    </div>
